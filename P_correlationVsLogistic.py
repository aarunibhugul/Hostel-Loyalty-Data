...
# pearson_corr = dum.corr()
#
# print(pearson_corr["Customer Key"].sort_values(axis=0,ascending=False))
# # list_for_featurescaling = list(pearson_corr.iloc[:,0])
# # list_for_featurescaling = sorted(list_for_featurescaling)
# # print(list_for_featurescaling)
#
#
